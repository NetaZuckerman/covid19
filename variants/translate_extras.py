...
for index, row in df.iterrows():
    ...
    gene_list = get_gene(nt_position) # its a list because some positions have 2 reading frames: 1-NSP 2-ORF.
                                      # 0 genes: the position is in UTR
                                      # 1 genes: the position has only one reading frame
